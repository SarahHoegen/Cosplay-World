                    ...
                    <h3>
                        O que está esperando? Crie sua conta e venha curtir com a gente!
                    </h3>
                    ...
                    <form role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="inputs">
                                <input type="text" name="email" class="form-control inputLogin" id="email1" placeholder="Digite seu email">
                            </div>
