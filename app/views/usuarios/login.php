...
<h3>Quer dar dicas incríveis e ajudar a galera toda? Entre em sua conta!</h3>
...
<a href="../../controllers/usuario/usuarios.php?acao=inserir"> <button type="button"  class="btn btn-outline-success" >Cadastrar-se </button> </a>
