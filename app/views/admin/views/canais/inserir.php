<h3 class="box-title">Inserir canal</h3>
</div>
...
<form method="post" action="?acao=inserir" enctype="multipart/form-data">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            <input type="text" name="nome" class="form-control" placeholder="Digite o nome do canal">
        </div>

        <div class="form-group">
            <label for="descricao">Descriçao</label>
            <textarea name="descricao" class="form-control" cols="50" rows="4" placeholder="Digite a descrição de seu canal"></textarea>
        </div>
